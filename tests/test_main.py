"""Tests for notion_automations.main and notion_automations.config."""
...
from notion_automations.main import main


def test_main_prints_greeting(capsys: pytest.CaptureFixture[str]) -> None:
    main()
    captured = capsys.readouterr()
    assert captured.out == "Hello from notion-automations!\n"
