...
The template uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to keep version numbers in sync across `pyproject.toml`, `src/notion_automations/__init__.py`, and `[tool.commitizen]`:
